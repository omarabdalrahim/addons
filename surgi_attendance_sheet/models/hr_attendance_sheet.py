        ...
        for att_sheet in self:
            ...
            for day in all_dates:
                ...
                if work_intervals:
                    ...
                    # if attendance_intervals:
                    #     for i, attendance_interval in enumerate(attendance_intervals):
                    #         temp_list = list(attendance_interval)
                    #         if temp_list[1] == False and temp_list[0]:
                    #             temp_list[1] = temp_list[0]
                    #         elif temp_list[0] == False and temp_list[1]:
                    #             temp_list[0] = temp_list[1]
                    #         attendance_intervals[i] = tuple(temp_list)
                    if attendance_intervals:
