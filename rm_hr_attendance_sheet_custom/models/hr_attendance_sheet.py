    ...
    def _get_workday_lines(self):
        for rec in self:
            if rec.contract_id:
                ...
                work_entry_types = rec.contract_id.structure_type_id.default_struct_id.unpaid_work_entry_type_ids
                ...
                overtime = [{
                    ...
                    'number_of_days': sum(line.amount for line in rec.penalty_ids.filtered(lambda slip: slip.type == 'ov')) / rec.contract_id.resource_calendar_id.hours_per_day , #self.tot_overtime
                }]
                absence = [{
                    'name': "Absence",
                    'code': 'ABS',
                    ...
                    'number_of_days': sum(line.amount for line in rec.penalty_ids.filtered(lambda slip: slip.type == 'ab')) / rec.contract_id.resource_calendar_id.hours_per_day, # self.tot_absence
                }]
                late = [{
                    'name': "Late In",
                    'code': 'LATE',
